...
class ActiveDirectoryAccessMask(AccessMask):
    ...
    RIGHTS = [
        ...
        {'abbr': 'CC', 'name': 'ADS_RIGHT_DS_CREATE_CHILD', 'val': 0x1, 'desc': 'Create child objects (possibly filtered by object class GUID)'},
        {'abbr': 'DC', 'name': 'ADS_RIGHT_DS_DELETE_CHILD', 'val': 0x2, 'desc': 'Delete child objects (possibly filtered by object class GUID)'},
        {'abbr': 'LC', 'name': 'ADS_RIGHT_ACTRL_DS_LIST', 'val': 0x4, 'desc': 'List child objects'},
        {'abbr': 'SW', 'name': 'ADS_RIGHT_DS_SELF', 'val': 0x8, 'desc': 'Perform a validated write (possibly filtered by validated write GUID)'},
        {'abbr': 'RP', 'name': 'ADS_RIGHT_DS_READ_PROP', 'val': 0x10, 'desc': 'Read properties (possibly filtered by property or property set GUID)'},
        {'abbr': 'WP', 'name': 'ADS_RIGHT_DS_WRITE_PROP', 'val': 0x20, 'desc': 'Write properties (possibly filtered by property or property set GUID)'},
        ...
        {'abbr': 'CR', 'name': 'ADS_RIGHT_DS_CONTROL_ACCESS', 'val': 0x100, 'desc': 'Perform a controlled operation (possibly filtered by extended right GUID)'},
    ]
